...
export default function Navbar(props: NavbarProps) {
  ...
  return (
    <header className="w-full fixed top-0 p-4 self-center flex justify-center backdrop-blur-xs backdrop-darken bg-black/50 shadow-[0_5px_15px_rgba(000,000,000,0.5)]">
